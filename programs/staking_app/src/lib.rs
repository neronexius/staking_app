...
use anchor_spl::{
    ...
    token::{Approve, Mint, MintTo, Revoke, Token, TokenAccount, ID as TOKENID, freeze_account, FreezeAccount},
};
...
declare_id!("7QSFTdoEfNbfR64ApnYuokLys4cTbBTxPFUxMfTSnVfg");
        ...
        token::mint_to(
            CpiContext::new_with_signer(
                ...
                MintTo {
                    ...
                    authority: ctx.accounts.stake_mint.to_account_info(),
                },
                &[&[
                    b"mint".as_ref(),
                    &[*ctx.bumps.get("stake_mint").unwrap()],
                ]],
            ),
